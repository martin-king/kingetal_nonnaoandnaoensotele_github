...
*'reinit'
*'sdfopen ensomixedpluscpmerge_prmslpronao_jfm_timevariesyears_025pctl.nc'
*'sdfopen ensomixedpluscpmerge_prmslpronao_jfm_timevariesyears_975pctl.nc'
...
**'set cmin 0'
**'d sign1*sign2'
'd maskout(prmslout.1*prmslout.2,prmslout.1*prmslout.2)'
